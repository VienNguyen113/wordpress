			...
			<footer role="contentinfo" class="footer">
				<div id="inner-footer" class="wrap clearfix">
					...
					<div class="attribution col940">
						...
						<?php else: ?>
						<p>&copy; <?php bloginfo('name'); ?> <?php _e('is powered by', 'popster'); ?> <a href="http://wordpress.org/" title="WordPress">WordPress</a> &amp; <a href="http://www.popster.com" title="popster" class="footer_bones_link"><?php _e('CircaThemes', 'popster'); ?></a>.</p>
						<?php endif; ?>
					</div> 
